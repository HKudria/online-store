    ...
    return (
        <div className={s.filterContent}>
            ...
            <div className={s.filtersWrapper}>
                ...
                <RangeBlock title="Price" from={store.minPrice} to={store.maxPrice} onChange={onChangePrice} initMax={store.initMaxPrice}/>
                <RangeBlock title="Stock" from={store.minStock} to={store.maxStock} onChange={onChangeStock} initMax={store.initMaxStock}/>
            </div>
        </div>
    )
}